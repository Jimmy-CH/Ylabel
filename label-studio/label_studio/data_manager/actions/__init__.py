...
from projects.template_translations import TITLE_TRANSLATIONS
...
def get_all_actions(user, project):
    ...
    for action in actions:
        if 'title' in action and action['title'] in TITLE_TRANSLATIONS:
            action['title'] = TITLE_TRANSLATIONS[action['title']]
