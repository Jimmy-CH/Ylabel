  ...
  const model = types
    ...
    .actions((self) => ({
      ...
      _performFetch: flow(function* ({
        ...
        console.log("lm------apiMethod------DataStore", root, apiMethod);

        const projectsStatusData = yield root.apiCall(
          "projectsStatus",
          {},
          {},
        ...
        self.projectsStatusData = projectsStatusData;
        if (list)
          self.setList({
            total,
            list,
