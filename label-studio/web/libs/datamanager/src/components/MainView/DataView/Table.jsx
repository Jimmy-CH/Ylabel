...
const injector = inject(({ store }) => {
  console.log("lm-------DataView-table", store);
...
export const DataView = injector(
  ({
    ...
    useEffect(() => {
      ...
      return () =>
        window.removeEventListener("dm:density:changed", handleDensityChange);
    }, []);
    ...
    const rowHeight =
      density === DENSITY_COMPACT ? ROW_HEIGHT_COMPACT : ROW_HEIGHT_COMFORTABLE;
