...
# === 汉化 title 字段 ===
TITLE_TRANSLATIONS = {
    'Generate Next Task': '生成下一个任务',
    'Cache Labels': '缓存标签',
    'Add Or Modify Data Field': '添加或修改数据字段',
    'Propagate Annotations': '传播标注',
    'Rename Labels': '重命名标签',
    'Retrieve Predictions': '获取预测结果',
    'Create Annotations From Predictions': '从预测结果创建标注',
    'Remove Duplicated Tasks': '移除重复任务',
    'Delete Tasks': '删除任务',
    'Delete Annotations': '删除标注',
    'Delete Predictions': '删除预测结果',
}
